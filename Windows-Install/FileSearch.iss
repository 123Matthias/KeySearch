...
#define MyAppExeName "FileSearch.exe"
...
[Files]
; 1. EXE ins Hauptverzeichnis
Source: "C:\git\OSWalk\dist\FileSearch\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
